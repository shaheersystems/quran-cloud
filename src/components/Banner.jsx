    ...
    <div className="max-h-fit py-10 px-10 flex items-center justify-center flex-col bg-teal-100">
      ...
      <div className="w-full py-5 flex items-center justify-center">
        ...
        >
          ...
          <span className="text-xl">What do you want to read?</span>
        </button>
      </div>
      <div className="pt-4 flex items-center gap-6 h-12">
        <Link
          to="/surah/36"
          className="py-1 px-3 shadow-xl bg-white rounded-full"
        >
          Yaseen
        </Link>
        <Link
